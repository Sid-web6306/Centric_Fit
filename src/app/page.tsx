  ...
  return (
    <MouseGradient>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <div className={`relative z-10 flex flex-col items-center justify-center min-h-[85vh] sm:min-h-[90vh] text-center px-4 sm:px-6 lg:px-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white mb-4 sm:mb-6 leading-tight">
            ...
            <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
              <Typewriter words={heroWords} typingSpeed={80} deletingSpeed={40} pauseDuration={2500} />
            </span>
          </h1>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8" role="group" aria-label="Company statistics">
              {stats.map((stat, index) => (
                <TiltCard key={index}>
                  <div
                    className={`text-center bg-slate-800/30 rounded-lg p-4 sm:p-6 backdrop-blur transition-all duration-500 hover:bg-slate-800/50 focus-within:ring-2 focus-within:ring-purple-400 hover:shadow-lg hover:shadow-purple-500/10 ${currentStat === index ? 'motion-safe:bg-slate-800/50 motion-safe:scale-105 motion-safe:shadow-lg' : ''
                      }`}
                    role="article"
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-10 sm:mb-12 lg:mb-16" role="group" aria-label="Main features">
              <ScrollReveal delay={0} direction="up">
                <TiltCard>
                  <Card className="bg-slate-800/50 border-slate-700 backdrop-blur hover:bg-slate-800/70 transition-all duration-200 sm:col-span-2 lg:col-span-1 focus-within:ring-2 focus-within:ring-purple-400 h-full">
                    <CardContent className="p-6 sm:p-8">
                      <FloatingElement duration={4} range={5}>
              ...
              <ScrollReveal delay={100} direction="up">
                <TiltCard>
                  <Card className="bg-slate-800/50 border-slate-700 backdrop-blur hover:bg-slate-800/70 transition-all duration-200 focus-within:ring-2 focus-within:ring-pink-400 h-full">
                    <CardContent className="p-6 sm:p-8">
                      <FloatingElement duration={4} delay={0.5} range={5}>
              ...
              <ScrollReveal delay={200} direction="up">
                <TiltCard>
                  <Card className="bg-slate-800/50 border-slate-700 backdrop-blur hover:bg-slate-800/70 transition-all duration-200 sm:col-span-2 lg:col-span-1 focus-within:ring-2 focus-within:ring-blue-400 h-full">
                    <CardContent className="p-6 sm:p-8">
                      <FloatingElement duration={4} delay={1} range={5}>
        ...
        {/* Product Showcase Section - Screenshots & Demos */}
        <ProductShowcase />
